...
<link href="assets/css/grayscale.min.css" rel="stylesheet">
    ...
    <body>
        <?php
            $price = $_GET['price'];
            $sql = "SELECT * FROM PCs pc, Products p WHERE pc.model = p.model AND pc.price = '".$price."'";
            ...
            if($resultCheck > 0){
              ...
              $PCResult = 'Opps No such PC Found, Try another one!';
        ...
        <h3 href="#result" class="text-uppercase m-0"> <?php echo $PCResult?></h3> 
